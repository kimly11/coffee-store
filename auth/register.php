...
if (isset($_POST['submit'])) {
    if (empty($_POST['username']) || empty($_POST['email']) || empty($_POST['password'])) {
        ...
        try {
            // Change named parameters to question marks
...
?>
    ...
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image: url(<?php echo APPURL; ?>/Imag/header.jpg);" data-stellar-background-ratio="0.5">
